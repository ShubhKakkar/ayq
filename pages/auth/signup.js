...
export default function index({session}) {
  ...
  return (
    <>
    <Head>
        <title>AyQ-SignUp</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <meta name="description" content="AyQ Beverages-SignUp" />
      </Head>
        ...
        <div className="xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center">
          <div className="bg-white shadow-lg rounded xl:w-1/3 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
            ...
            <div className="mt-6 w-full">
              ...
              <div className="relative flex items-center justify-center">
                <input
                  ...
                  className="bg-gray-200 border rounded text-xs outline-none font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"
                  ref={passwordRef}
                />
                <div
            ...
            <div className="mt-8">
              <button
                role="button"
                className="focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 text-sm font-semibold leading-none text-white focus:outline-none bg-orange-400 border rounded hover:bg-orange-500 ease-in-out duration-300 py-4 w-full"

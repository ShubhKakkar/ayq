...
const FAQ = () => {
  return (
    <div class="mx-auto bg-white min-h-sceen">
      <div class="flex flex-col items-center">
        <h2 class="font-bold font-Roboto text-5xl mt-5 tracking-tight">FAQ</h2>
        <p class="uppercase text-lg font-bold text-neutral-500 mt-8 tracking-widest leading-loose">
          Frequenty asked questions
        </p>
      </div>
      <div class="grid divide-y divide-neutral-200 mx-auto mt-8 font-Roboto">
        <div class="py-5">
          <details class="group">
